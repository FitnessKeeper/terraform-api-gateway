...
resource "aws_api_gateway_deployment" "prod" {
  rest_api_id       = aws_api_gateway_rest_api.webapi.id
  description       = "Deployment of webapi prod - ${local.aws_api_gateway_deployment_name}"
  stage_name        = "prod"
  stage_description = "Deployment of webapi prod - ${local.aws_api_gateway_deployment_name}"
